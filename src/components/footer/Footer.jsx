...
const Footer = () => {
  ...
  return (
    <div className='2xl:w-[100%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] 2xl:h-[800px] xl:h-[800px] lg:h-[750px] md:h-[700px] sm:h-[680px] bg-[#088269]'>
        ...
        <div className='w-[100%] md:w-[100%] 2xl:w-[100%] lg:w-[100%] xl:w-[100%] sm:w-[100%] mx-auto 2xl:flex xl:flex lg:flex md:flex sm:flex 2xl:justify-between md:gap-10 sm:justify-between'>
          <div className='2xl:w-[250px] xl:w-[250px] lg:w-[230px] md:w-[200px] sm:w-[120px] mt-[60px] '>
            ...
            <div className={`2xl:flex xl:flex lg:flex  gap-[100px] 2xl:justify-between xl:justify-between lg:justify-between md:justify-between sm:justify-between mt-[20px] 2xl:w-full xl:w-full lg:w-full md:w-full sm:w-full  w-[98%] mx-auto overflow-hidden transition-all duration-500 ${isOpen.buyers ? 'max-h-[500px]' : 'max-h-0'} 2xl:overflow-visible xl:overflow-visible lg:overflow-visible md:overflow-visible sm:overflow-visible`}>
              <ul>
                <li className='text-white cursor-pointer font-light 2xl:text-[16px] xl:text-[16px] lg:text-[15px] md:text-[12px] sm:text-[12px]'>О компании</li>
          ...
          <div className='2xl:flex xl:flex lg:flex md:flex sm:flex justify-between 2xl:w-full xl:w-full lg:w-full md:w-full sm:w-full  w-[98%] mx-auto '>
            ...
            <div className='mt-[20px]'>
              ...
              <div className='flex gap-3 mt-[7px]'>
                <img className='cursor-pointer md:w-[35px] 2xl:w-[50px] h-[35px] sm:w-[30px]' src={mip} alt="" />
                <img className='cursor-pointer md:w-[35px] 2xl:w-[50px] h-[35px] sm:w-[30px]' src={mastercard} alt="" />
                <img className='cursor-pointer md:w-[35px] 2xl:w-[50px] h-[35px] sm:w-[30px]' src={visa} alt="" />
              </div>
            </div>
          </div>
