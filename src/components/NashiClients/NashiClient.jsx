        ...
        <div className='w-[100%] bg-[#D5D1E1] mx-auto'>
            <div className='w-[100%]  mx-auto h-auto mt-5 mb-5 p-5'>
                <div className='w-[100%] 2xl:w-[100%] mx-auto'>
                    <div className='w-[90%] 2xl:w-[1440px] flex flex-wrap justify-between items-center mx-auto'>
                        <h3 className='text-[30px]'>Наши клиенты</h3>
                        <h1 className='text-[18px] md:text-[34px] lg:text-[38px] xl:text-[42px] 2xl:text-[44px] font-medium mt-2 w-full md:w-auto'>
