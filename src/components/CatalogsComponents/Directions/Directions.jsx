                        ...
                        {directData.map((item, index) => (
                            <div className='border'>
                                <div className='2xl:w-[100%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] h-[150px] rounded-[10px] border flex'>
                                    ...
                                    <div className='w-[60%] flex items-center justify-center text-[14px]'><p className='w-[95%] h-[100px] flex items-center mx-auto 2xl:text-[16px] xl:text-[15px] lg:text-[14px] md:text-[13px] sm:text-[12px] text-[10px]'>{item.common_name}</p></div>
                                </div>
                            </div>
                        ))}
                    </>
        ...
        <div>
            <div className='w-[95%] 2xl:w-[1440px] mb-[80px] mx-auto mt-[40px]'>
                <div className='xl:w-[100%] xl:h-[1200px] lg:w-[100%] md:w-[100%] 2xl:flex xl:flex lg:flex md:flex justify-between mx-auto'>
                    <div className='2xl:w-[29%] xl:w-[22%] lg:w-[27%] md:w-[25%] sm:w-[100%] h-auto border rounded-[10px] md:order-2 sm:order-1 2xl:order-1 xl:order-1 lg:order-1 2xl:h-auto xl:h-auto lg:h-auto md:h-[530px] sm:h-auto sm:mb-[10px] sm:flex sm:items-center 2xl:items-start xl:items-start lg:items-start'>
                        <div className='w-[95%] mx-auto'>
                            <h2 className='text-[20px] mt-[20px] mb-[20px] flex items-center gap-2 cursor-pointer px-4 py-2 border border-gray-300 rounded-[10px] shadow-sm' onClick={toggleList}>
                                <MdOutlineChecklist className='text-[20px]' onClick={toggleList} /> Направления
                            </h2>
                            {isOpen && (
