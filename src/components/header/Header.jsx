...
const Header = () => {
    ...
    const handleClickOutside = (event) => {
        ...
        if (modalRef.current && !modalRef.current.contains(event.target)) {
            ...
            document.body.style.overflow = 'auto'; // Enable background scroll when modal is closed
        }
    };
    ...
    return (
        <div className='w-[100%] md:w-[100%] 2xl:w-[1440px] h-auto mt-2 2xl:mt-0 md:mt-0 mx-auto'>
            <div className='w-[1440px] h-[40px] mx-auto justify-between sm:w-[95%] hidden md:flex 2xl:flex md:w-[95%] lg:w-[95%] xl:w-[95%] 2xl:w-[1440px]'>
                <ul className='flex items-center md:gap-4 lg:gap-5 xl:gap-6 2xl:gap-6'>
                    <li className='text-[gray] cursor-pointer 2xl:block md:text-[13px] lg:text-[15px] xl:text-[16px] 2xl:text-[16px]'><Link to='/acompany'>О компании</Link></li>
                    ...
                    <li className='text-[gray] cursor-pointer 2xl:block md:text-[13px] lg:text-[15px] xl:text-[16px] 2xl:text-[16px]'>Оплата</li>
                    <li className='text-[gray] cursor-pointer 2xl:block md:text-[13px] lg:text-[15px] xl:text-[16px] 2xl:text-[16px]'>Гарантии</li>
                    <li className='text-[gray] cursor-pointer 2xl:block md:text-[13px] lg:text-[15px] xl:text-[16px] 2xl:text-[16px]'>Блог</li>
                </ul>
            ...
            <div className='w-[100%] relative h-[120px] justify-evenly items-center 2xl:h-[100px] mx-auto md:flex 2xl:flex 2xl:justify-between 2xl:items-center md:w-[95%] md:h-[70px] lg:w-[95%] xl:w-[95%] 2xl:w-[95%]'>
                <div className='md:w-[18%] 2xl:w-[20%] lg:[10%] flex 2xl:justify-start xl:justify-start justify-between w-[95%] mx-auto'>
                    <Link to='/'><img src={logo} alt="" className='md:w-[100px] md:h-[40px] 2xl:w-[120px] 2xl:h-[45px] cursor-pointer' /></Link>
                ...
                {isModalVisible && (
                    <div className='w-[100%] fixed inset-0 shadow-lg shadow-cyan-500/50 flex items-center justify-center z-50'>
                        <div ref={modalRef} className='bg-white p-8 rounded-lg 2xl:w-[700px] 2xl:h-[500px] xl:h-[500px] lg:h-[500px] md:h-[500px] sm:h-[550px] lg:w-[650px] md:w-[600px] sm:w-[400px] w-[300px] h-[700px]'>
                ...
                <div className='2xl:flex 2xl:items-center justify-start gap-[40px] 2xl:w-[60%] md:w-[60%] w-[95%] mx-auto mt-5 md:mt-0 2xl:mt-0'>
                        ...
                        {isCategoryVisible && (
                            <div className='absolute z-20 top-[50px] left-0 w-[300px] h-auto bg-white border border-gray-200 shadow-lg' ref={dropdownRef}>
                                <ul className='w-[90%] mx-auto mt-[10px] mb-[10px]'>
                                    ...
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Проктологическое оборудование</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Рентген аппараты</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Кардиологическое оборудование</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Оборудование для стерилизации и дезинфекции</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Стоматологическое оборудование</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >УЗИ аппараты</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Урологическое оборудование</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Физиотерапевтическое оборудование</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Аппараты для функциональной диагностики</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Хирургические инструменты</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Эндоскопия</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Медицинские симуляторы</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Медицинские анализаторы электробезопасности</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Медицинские светильники</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Дозиметрическое оборудование</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Оборудование для радиационной терапии</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Отоскопы Heine</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Центральные мониторные станции для комплексного отслеживания всех основных параметров</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Лучевая диагностика</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Хирургические микроскопы</li>
                                    <li className='w-[250px] mt-[10px] font-light text-[15px] cursor-pointer' >Косметология</li>
                                </ul>
                            </div>
                        )}
                    </div>
                ...
                <div className='2xl:w-[20%] md:w-[21%] xl:w-[25%] lg:w-[25%] '>
                    <ul className='flex justify-between xl:gap-2 lg:gap-2 '>
                        <li className='hidden cursor-pointer 2xl:flex md:flex flex-col items-center text-[gray]' ><CiUser className='text-[26px] text-[black]' /><p className='md:hidden 2xl:block xl:block lg:block lg:text-[14px]' >Войти</p></li>
                        <li className='hidden cursor-pointer 2xl:flex md:flex flex-col items-center text-[gray]' ><GoHeart className='text-[26px] text-[black]' /><p className='md:hidden 2xl:block xl:block lg:block lg:text-[14px]'>Избранное</p></li>
                        <li className='hidden cursor-pointer 2xl:flex md:flex flex-col items-center text-[gray]' ><MdOutlineAlignVerticalBottom className='text-[26px] text-[black]' /><p className='md:hidden 2xl:block xl:block lg:block lg:text-[14px]'>Сравнить</p></li>
                        <li className='hidden cursor-pointer 2xl:flex md:flex flex-col items-center text-[gray]' ><SlBasket className='text-[26px] text-[black]' /><p className='md:hidden 2xl:block xl:block lg:block lg:text-[14px]'>Корзина</p></li>
                    </ul>
                </div>
            </div>
            <hr className='w-[100%]' />
            <div className='w-[100%] mx-auto h-[70px] justify-between items-center hidden md:flex 2xl:flex md:w-[95%] lg:w-[95%] xl:w-[95%] 2xl:w-[1440px]'>
                <ul className='flex items-center 2xl:gap-6 md:gap-3 h-[100%]'>
                    ...
                    <li className='font-medium md:text-[13px] cursor-pointer'>Производители</li>
                    <li className='font-medium md:text-[13px] cursor-pointer'>Кабинеты под ключ</li>
                    <li className='font-medium md:text-[13px] cursor-pointer'>Услуги</li>
                    <li className='font-medium md:text-[13px] cursor-pointer'>Акции</li>
                    <li className='font-medium md:text-[13px] cursor-pointer'>Покупателям</li>
                    <li className='font-medium md:text-[13px] cursor-pointer'>Контакты</li>
                </ul>
