...
const Infarmation = () => {
    ...
    return (
        <div className='w-[100%] h-[700px] bg-[#088269] mb-[20px] 2xl:flex xl:flex lg:flex md:flex sm:flex items-center'>
            <div className='w-[95%] 2xl:w-[1440px] xl:w-[95%] lg:w-[95%] h-[90%] mx-auto 2xl:flex xl:flex xl:flex-row 2xl:flex-row lg:flex-row md:flex-row sm:flex-row lg:flex md:flex sm:flex flex flex-col justify-center items-center '>
                <div className='text-center 2xl:text-start xl:text-start lg:text-start md:text-start sm:text-start 2xl:w-[50%] xl:w-[50%] lg:w-[50%] md:w-[50%] sm:w-[50%] 2xl:h-full xl:h-full lg:h-full md:h-full sm:h-full w-[100%] 2xl:pt-0 xl:pt-0 lg:pt-0 md:pt-0 sm:pt-0 pt-[20px]'>
                    <h2 className='2xl:text-[36px] xl:text-[34px] lg:text-[32px] md:text-[30px] sm:text-[28px] text-[24px] font-semibold text-white'>Информация о компании</h2>
                </div>
        ...
        <div key={sectionId} className='w-[100%] ' >
            <div className='2xl:w-[95%] xl:w-[95%] lg:w-[95%] md:w-[95%] sm:w-[95%] w-[100%] mx-auto'>
                <div className='flex justify-between mt-[20px]'>
                    <h2 className='text-[20px] text-white flex items-center gap-2'>
                        {title}
                        {title === 'Подробнее' && <CgArrowTopRight />}
                    </h2>
                    <div
                        className={`w-[35px] h-[35px] border text-white rounded-full font-semibold text-[22px] flex items-center justify-center cursor-pointer transition-transform duration-300 ${isExpanded ? 'rotate-90 [transition:0.3s] bg-white text-black' : ''}`}
