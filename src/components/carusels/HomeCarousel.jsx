...
import { FaArrowLeft, FaArrowRight } from "react-icons/fa"; // FaRightLeft ni o'chirdim, FaArrowRight ni qo'shdim
...
export default function SimpleSlider() {
    ...
    return (
        <div className="w-[95%] 2xl:w-[1440px] xl:w-[95%] lg:w-[95%] md:w-[95%] 2xl:h-[450px] xl:h-[400px] md:h-[250px] lg:h-[360px] sm:h-[450px] h-[500px] mx-auto mt-10">
            <Slider {...settings}>
                {Data.map((item, index) => (
                    <div key={index} className=" w-[100%] 2xl:h-[100%] xl:h-[100%] lg:h-[100%] sm:h-[100%] md:h-[100%] h-[100%]  bg-[#D5D1E1] rounded-[20px]">
                        <div className="2xl:flex xl:flex lg:flex md:flex h-[100%] 2xl:h-[100%] xl:h-[100%] md:h-[100%] lg:h-[100%]">
                            <div className=" h-[45%] w-[100%] p-4 2xl:w-[40%] xl:w-[35%] lg:w-[32%] md:w-[35%] sm:w-[100%] sm:h-[40%] 2xl:block xl:block lg:block md:block sm:flex sm:flex-col sm:items-center ">
                                ...
                                <div className="mt-[30px] 2xl:mt-[80px] xl:mt-[60px] lg:mt-[80px] 2xl:ml-[30px] xl:ml-[30px] md:ml-[20px] sm:ml-[10px] flex">
                                    <button className='h-[40px] w-[49%] text-[11px] 2xl:w-[150px] xl:w-[140px] xl:h-[45px] 2xl:h-[42px] lg:h-[38px] 2xl:text-[16px] lg:text-[12px] md:text-[10px] md:w-[100px] md:h-[30px] lg:w-[120px] sm:w-[100px] sm:text-[10px] sm:h-[30px]  border rounded-[20px] text-white font-normal bg-[#088269] mr-2'>{item.bg_title}</button>
                                    <button className='h-[40px] w-[49%] text-[11px] 2xl:w-[150px] xl:w-[130px] xl:h-[45px] 2xl:h-[42px] lg:h-[38px] 2xl:text-[16px] lg:text-[12px] md:text-[10px] md:w-[100px] md:h-[30px] lg:w-[100px] sm:w-[100px] sm:text-[10px] sm:h-[30px]  border rounded-[20px] text-[#088269] font-medium'>{item.wh_title}</button>
                                </div>
                            </div>
