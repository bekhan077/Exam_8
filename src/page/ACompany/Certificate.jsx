...
const Certificate = () => {
    ...
    return (
        <div className='w-[100%] h-[550px] mx-auto mt-[10px] mb-[40px] '>
            <div className='2xl:w-[1445px] xl:w-[95%] lg:w-[95%] md:w-[95%] sm:w-[95%] w-[95%] h-[100%] 2xl:flex xl:flex lg:flex md:flex  items-center mx-auto'>
                <div className='2xl:w-[20%] xl:w-[20%] lg:w-[20%] md:w-[20%] 2xl:h-[100%] xl:h-[100%] lg:h-[100%] md:h-[100%] h-[25%] p-4 '>
                    ...
                    <ul className='mt-[20px]'>
                        <li className='text-gray-500 cursor-pointer'>Эксклюзивные поставщики</li>
                    </ul>
                </div>
                    ...
                    <Slider ref={sliderRef} {...settings} className='w-full mx-auto mt-[50px]'>
                        {certificate.map((item, index) => (
                            <div key={index} className='px-2'>
                                <div className="w-[100%] h-[200px] border rounded-[20px]">
                                    <div className="w-[100%] h-[100%] bg-[white] flex items-center justify-center relative border">
                                        <img
                                            src={item.img}
                                            alt={`Complex ${index + 1}`}
