...
const Doctors = () => {
    ...
    return (
        <div className='2xl:w-[1440px] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] w-[100%] 2xl:h-[500px] xl:h-[500px] lg:h-[500px] md:h-[900px] mx-auto mt-[20px]'>
            <div className='w-[100%] h-[100%] 2xl:flex xl:flex lg:flex border'>
                        ...
                        {isMobile ? (
                            ...
                            <div className='w-[100%] h-[100%] flex'>
                                <div className='flex w-[100%] h-[100%]'>
                                    <div className='w-[60%] h-[80%] border rounded-[10px]'>
